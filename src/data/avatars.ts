...
export const avatarsArray: AvatarProps[] = [
  { imgUrl: 'avatars/2.svg', name: 'afro-F', link: '', sexe: 'femme', race: 'afro', author: 'Gilka' },
  { imgUrl: 'avatars/3.svg', name: 'amerindien-F', link: '', sexe: 'femme', race: 'amerindien', author: 'Gilka' },
  { imgUrl: 'avatars/9.svg', name: 'oceanien-F', link: '', sexe: 'femme', race: 'oceanien', author: 'Gilka' },
  { imgUrl: 'avatars/7.svg', name: 'caucasien-F', link: '', sexe: 'femme', race: 'caucasien', author: 'Gilka' },
  { imgUrl: 'avatars/5.svg', name: 'asiat-F', link: '', sexe: 'femme', race: 'asiat', author: 'Gilka' },
